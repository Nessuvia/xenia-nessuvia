 ...
 *
 * A card in flight can't be measured. `getBoundingClientRect` reports only the transform an
...
/** Drops anything outstanding. Called when a board unmounts. A half-played hand can't make the
