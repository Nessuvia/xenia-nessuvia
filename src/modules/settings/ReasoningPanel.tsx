...
/**
 * Think-block markers for this connection. They are a property of the model, which is why they sit
 * here rather than in the global tag rules; with this off, the tag rules in Text rules still apply.
 */
