...
// exist. A finding the Slop-dentifier shows is the same finding a pipeline would act on.
...
export function analyseText(
  ...
  const score = scoreText(cleaned, {
    // No chat behind this screen. There is no history to build a census from. The census part
